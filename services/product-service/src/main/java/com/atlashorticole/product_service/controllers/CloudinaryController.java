...
public class CloudinaryController {
    ...
    public ResponseEntity<FileUploadResponse> uploadImage(
            @Parameter(description = "Image file to upload (JPG, PNG, GIF, etc.)")
    ...
    public ResponseEntity<MultipleFileUploadResponse> uploadMultiple(
            ...
            @Parameter(description = "Technical sheet PDF")
            @RequestParam(value = "technicalSheet", required = false) MultipartFile technicalSheet) {
    ...
    public ResponseEntity<Map<String,Object>> deleteFile(
            @Parameter(description = "Public ID of the file to delete")
            @RequestParam("publicId") @NotNull String publicId,
            @Parameter(description = "Resource type (image , raw for  documents)")
    ...
    public ResponseEntity<Map<String, Object>> deletePdf(
            @Parameter(description = "Public ID of the PDF to delete")
            @RequestParam("publicId") @NotNull String publicId) {
